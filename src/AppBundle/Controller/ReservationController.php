...
class ReservationController extends Controller
{
    ...
    public function newAction(Request $request, Mailer $mailer)
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            $em->flush();
            // Pilot mail
            $mailer->sendMail($reservation->getFlight()->getPilot()->getEmail(),'reservation@flyaround.com','notification');
            $mailer->sendMail($this->getUser()->getEmail(), 'reservation@flyaround.com', 'confirmation');
